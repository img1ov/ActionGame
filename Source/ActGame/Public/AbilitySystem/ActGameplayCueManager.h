...
#include "ActGameplayCueManager.generated.h"
...
/**
 * UActGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UActGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()
	
public:
	
	UActGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	
	static UActGameplayCueManager* Get();

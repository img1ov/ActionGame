...
#include "ActAbilityTagRelationshipMapping.generated.h"

class UObject;

USTRUCT()
struct FActAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class ACTGAME_API UActAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FActAbilityTagRelationship> AbilityTagRelationships;
};

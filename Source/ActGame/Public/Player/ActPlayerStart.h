...
#include "ActPlayerStart.generated.h"
...
enum class EActPlayerStartLocationOccupancy
{
	Empty,
	Partial,
	Full
...
class AActPlayerStart : public APlayerStart
{
	GENERATED_BODY()

public:
	UE_API AActPlayerStart(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	const FGameplayTagContainer& GetGameplayTags() { return StartPointTags; }

	UE_API EActPlayerStartLocationOccupancy GetLocationOccupancy(AController* const ControllerPawnToFit) const;

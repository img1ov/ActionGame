...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ActVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// ActVerbMessage

FString FActVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FActVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UActVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UActVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UActVerbMessageHelpers::VerbMessageToCueParameters(const FActVerbMessage& Message)
{
...
FActVerbMessage UActVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FActVerbMessage Result;
